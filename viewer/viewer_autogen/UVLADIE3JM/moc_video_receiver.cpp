...
QT_MOC_LITERAL(5, 43, 11) // "onReadyRead"

    },
    "VideoReceiver\0statusChanged\0\0message\0"
    "start\0onReadyRead"
};
...
void VideoReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoReceiver::statusChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoReceiver::statusChanged(const QString & _t1)
{
